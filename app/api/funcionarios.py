...
def atualizar_funcionario(id):
    try:
        ...
        if cep:
            funcionario.cep = cep
            funcionario.rua = request.json.get('rua')
            funcionario.numero = request.json.get('numero')
            funcionario.bairro = request.json.get('bairro')
            funcionario.cidade = request.json.get('cidade')
            funcionario.uf = request.json.get('uf')
        if departamento:
